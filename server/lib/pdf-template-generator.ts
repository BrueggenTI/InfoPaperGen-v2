...
<head>
    ...
    <style>
      ...
      /* Additional PDF-specific styles that shouldn't be in the live preview */
      body {
    ...
    <div class="pdf-preview-container">
        ...
        <div class="warning-box avoid-break">
            <div class="warning-content">
                <svg class="warning-icon" fill="currentColor" viewBox="0 0 20 20" style="width: 20px; height: 20px; margin-right: 12px; flex-shrink: 0;">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            ${formData.showCountryOfOriginInPDF ? `<th>Country of Origin</th>` : ''}
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            ${formData.showCountryOfOriginInPDF ? `<td>${ingredient.origin || "-"}</td>` : ''}
                        </tr>
                        `).join('')}
                    </tbody>
                </table>
        ...
        <div class="footer-section avoid-break">
            <div class="footer-grid">
                <div class="footer-item">
                    <svg class="footer-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 16px; height: 16px; margin-right: 8px; color: #6b7280;">
