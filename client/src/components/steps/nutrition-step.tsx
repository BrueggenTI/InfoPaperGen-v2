...
import { AIExtractionStatus, NutritionField, getValidClaims } from "./nutrition-helpers";
...
export default function NutritionStep({
  ...
  const nutrition: NutritionValues = watchedValues && Object.keys(watchedValues).length > 1 ? watchedValues : defaultNutrition;
