...
export default function NutritionStep({ formData, onUpdate, onNext, onPrev, isLoading = false }: NutritionStepProps) {
  ...
  const currentDeclarations = formData.declarations || { sourceOfProtein: false, highInProtein: false, sourceOfFiber: false, highInFiber: false, wholegrain: false, manualClaims: [] };
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <Card>
        ...
        <CardContent>{/* ... (form and fields) ... */}</CardContent>
      </Card>
                  ...
                  <div className="relative w-24">
                    <Input type="number" step="0.1" min="0" placeholder="e.g. 45.5" value={currentDeclarations?.wholegrainPercentage || ''}
                      onChange={(e) => {
                        ...
                        onUpdate({ declarations: { ...currentDeclarations, wholegrainPercentage: value === '' ? undefined : parseFloat(value) } });
                      }}
