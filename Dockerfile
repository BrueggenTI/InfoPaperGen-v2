...
# === NEU: Chrome-Abhängigkeiten und Chrome selbst installieren ===
# Notwendig, damit Puppeteer während des 'npm run build' funktioniert.
USER root
...
# Puppeteer anweisen, den System-Chrome zu verwenden und den Download zu überspringen
ENV PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true
ENV PUPPETEER_EXECUTABLE_PATH=/usr/bin/google-chrome-stable
# === Ende der Chrome-Installation ===
